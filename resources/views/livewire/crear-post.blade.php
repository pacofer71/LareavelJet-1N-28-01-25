    ...
    <x-dialog-modal maxWidth='4xl' wire:model="openModalCrear">
        ...
        <x-slot name="content">
             ...
             <div class="mb-4">
                ...
                <input type="text" id="titulo" name="titulo" class="w-full p-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Ingrese el título del post" required>
            </div>

            <!-- Campo Contenido -->
            <div class="mb-4">
                <label for="contenido" class="block text-gray-700 font-medium mb-2">Contenido</label>
                <textarea id="contenido" name="contenido" rows="4" class="w-full p-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Escribe el contenido del post" required></textarea>
            </div>
            ...
            <div class="mb-4">
                ...
                <div class="flex items-center space-x-4">
                    <label class="flex items-center space-x-2">
                        <input type="radio" id="publicado" name="estado" value="Publicado" class="text-blue-500" required>
                        <span class="text-gray-700">Publicado</span>
                    </label>
                    <label class="flex items-center space-x-2">
                        <input type="radio" id="borrador" name="estado" value="Borrador" class="text-blue-500" required>
        ...
        <div class="flex justify-between">
                ...
                <button type="button" class="bg-gray-300 text-gray-700 py-2 px-4 rounded-md hover:bg-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-500">Cancelar</button>
